...
VALUES
('El amor en los tiempos del cólera', 'Romance', 'Gabriel García Márquez', 368, 'Bueno', 7.40, 'https://imagessl1.casadellibro.com/a/l/s7/51/9788497592451.webp', 'La historia de amor entre Florentino Ariza y Fermina Daza, personajes cuyas vidas transcurren a lo largo del siglo XIX y principios del XX en distintos pueblos y ciudades de Colombia. Florentino y Fermina se enamoran cuando son jóvenes, pero Fermina termina casándose con un médico adinerado. A pesar de este matrimonio, Florentino nunca dejará de amarla y esperará pacientemente el momento de volver a encontrarse con ella.'),
('El retrato de Dorian Gray', 'Ficción', 'Oscar Wilde', 272, 'Bueno', 5.45, 'https://imagessl2.casadellibro.com/a/l/s7/42/9788467070842.webp', 'El retrato de Dorian Gray es una novela que explora los límites morales y el alma humana. Dorian Gray, un joven bello y seductor, intercambia su alma por la inmortalidad. Mientras su retrato envejece y se vuelve cada vez más oscuro, él permanece joven y hermoso. La historia trata sobre la corrupción moral y los dilemas éticos que acompañan la búsqueda de la eterna juventud y el placer.'),
('La metamorfosis', 'Ficción', 'Franz Kafka', 160, 'Bueno', 3.35, 'https://m.media-amazon.com/images/I/81B6ebdgtZL._AC_UF1000,1000_QL80_.jpg', 'Gregor Samsa despierta una mañana para descubrir que se ha transformado en un enorme insecto. La historia sigue sus intentos por adaptarse a su nueva forma y a las reacciones de su familia y del mundo exterior frente a su repentina metamorfosis. La obra de Kafka es una reflexión sobre la alienación, la soledad y la condición humana.'),
('1984', 'Ficción', 'George Orwell', 328, 'Bueno', 6.60, 'https://imagessl4.casadellibro.com/a/l/s7/44/9788499890944.webp', '1984 es una novela distópica que describe un futuro totalitario y opresivo en el que el gobierno controla todos los aspectos de la vida de las personas, incluso sus pensamientos y emociones. La historia sigue a Winston Smith, quien desafía el régimen autoritario del Gran Hermano y lucha por su libertad individual.'),
('El señor de los anillos', 'Fantasía', 'J.R.R. Tolkien', 1392, 'Decente', 28.00, 'https://medios.lamarmota.es/senor-de-los-anillos.jpeg', 'En la Tierra Media, el Señor Oscuro Sauron ordenó a los Elfos que forjaran los Grandes Anillos de Poder. Tres para los reyes Elfos, siete para los Señores Enanos, y nueve para los Hombres Mortales. Pero Saurón también forjó, en secreto, el Anillo Único, que tiene el poder de esclavizar toda la Tierra Media. Con la ayuda de sus amigos y de valientes aliados, el joven hobbit Frodo emprende un peligroso viaje con la misión de destruir el Anillo Único. Pero el malvado Sauron ordena la persecución del grupo, compuesto por Frodo y sus leales amigos hobbits, un mago, un hombre, un elfo y un enano. La misión es casi suicida pero necesaria, pues si Sauron con su ejército de orcos lograra recuperar el Anillo, sería el final de la Tierra Media.'),
